...
class FirmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create firm" do
    assert_difference('Firm.count') do
      post firms_url, params: { firm: { afip_condition: @firm.afip_condition, cuit: @firm.cuit, name: @firm.name } }
    end
  ...
  test "should update firm" do
    patch firm_url(@firm), params: { firm: { afip_condition: @firm.afip_condition, cuit: @firm.cuit, name: @firm.name } }
