...
class OrderStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_status" do
    assert_difference('OrderStatus.count') do
      post order_statuses_url, params: { order_status: { detail: @order_status.detail, order_id: @order_status.order_id, status: @order_status.status } }
    end
  ...
  test "should update order_status" do
    patch order_status_url(@order_status), params: { order_status: { detail: @order_status.detail, order_id: @order_status.order_id, status: @order_status.status } }
